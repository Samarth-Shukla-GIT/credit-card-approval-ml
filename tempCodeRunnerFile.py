...
days_birth = st.number_input("Days Birth (negative values like dataset)", value=-12000)
days_employed = st.number_input("Days Employed (negative if currently working)", value=-1000)
